...
pdf_summarize_pages(file_path, page_start, page_end)
...
pdf_read_pages(file_path, page_start, page_end)
...
pdf_read_pages_detailed(file_path, page_start, page_end)
...
pdf_extract_images(file_path, page_start, page_end)
...
pdf_annotate_images(file_path, annotations)
...
pdf_rag_search(file_path, query)
...
- Dùng pdf_rag_search(file_path, query) để định vị trang
